...
function toggleMarkerClusterer() {
  ...
  if (showMarketClusterer) {
    if (mc) {
      ...
      alert(mc.isZoomOnClick());
    } else {
      mc = new MarkerClusterer(map, markers.locations, {maxZoom: 19,zoomOnClick: false});
      alert(mc.isZoomOnClick());
    }
  } else {
    mc.clearMarkers();
